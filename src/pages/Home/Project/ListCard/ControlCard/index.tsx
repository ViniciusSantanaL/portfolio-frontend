...
interface ControlListCardProps {
    ...
    setActualPositions: React.Dispatch<React.SetStateAction<{start: number, end: number}>>;
}
export function ControlListCard({ listCardSize, actualPositions, setActualPositions }: ControlListCardProps) {
    ...
    return (
        <div className={styles["control-cards-container"]}>
            <button className={styles["control-cards-previous-button"]}>PREVIOUS</button>
