...
import { ControlListCard } from './ControlCard'
...
export function ListCard() {
  ...
  if (isLoading) {
    return (
      <div role="status">
        <svg
          aria-hidden="true"
          className="inline w-16 h-16 mt-10 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
          viewBox="0 0 100 101"
          fill="none"
  ...
  return (
    <div className="w-full h-[500px] animate-fadeIn opacity-0">
